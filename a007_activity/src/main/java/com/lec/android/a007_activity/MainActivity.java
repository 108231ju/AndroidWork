...
public class MainActivity extends AppCompatActivity {
    ...
    // 엑티비티가 동작, 즉 사용자와의 상호작용( 포커스를 갖기 시작) 할떄 호출
    @Override
    ...
    // 다른 엑티비티가 보여질때 ( 혹은 다른 엑티비티에 의해 가려지기 시작할때) 호출
    // 엑티비티를 통해 다루고 있던 데이터 저장, 쓰레드 중지.. 등의 처리를 해야함
    @Override
