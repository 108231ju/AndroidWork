...
//          맞춰줌
        ...
        btnMultiChoice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showAler(DIALOG_MULTICHOICE);
            }
        });

    }

    protected AlertDialog.Builder showAler(int id){
